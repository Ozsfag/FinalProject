...
public class SiteHandlerTest {
    ...
    public void setUp() {
        ...
        entityHandler = new EntityHandler(siteRepository, lemmaRepository, indexRepository, morphology, pageRepository, lemmaHandler, indexHandler, pageHandler);
    }
    ...
    public void testGetIndexedSiteModelFromSites_WhenSiteIsNotInConfiguration() {
        ...
        List<SiteModel> result = (List<SiteModel>) siteHandler.getIndexedSiteModelFromSites(Collections.singletonList(site));
