...
//        ConnectionSettings.builder().userAgent("User Agent").referrer("Referrer").build();
//    webScraper = new WebScraper(connectionSettings);
//    document = Jsoup.connect(correctUrl).get();
//  }
//
//  @Test
//  public void testGetConnectionDto_Success() {
//
//    String content = "This is the content";
//    Set<String> urls = Set.of("http://example.com/page1", "http://example.com/page2");
//
//    ConnectionDto response = webScraper.getConnectionDto(correctUrl);
//
...
//
//  @Test
//  public void testGetConnectionDto_IOException() {
//    String incorrectUrl = "http://qwezxcasdf.com";
//    ConnectionDto response = webScraper.getConnectionDto(incorrectUrl);
//
