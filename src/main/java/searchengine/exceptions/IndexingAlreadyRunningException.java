...
/**
 * Exception thrown when an attempt is made to start an indexing operation
 * while another indexing operation is already running.
 * <p>
 * This exception is used to prevent concurrent indexing operations that
 * could lead to data inconsistency or performance issues.
 * </p>
 */
