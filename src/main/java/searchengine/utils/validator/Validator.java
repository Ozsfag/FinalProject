...
public class Validator {
  ...
  /**
   * Checks if the given URL has the correct form by verifying that it is in the application
   * configuration, has the correct ending, and does not contain repeated components.
   *
   ...
   */
  public boolean urlIsInApplicationConfiguration(
  ...
  /**
   * Checks if the given URL is not repeated by splitting it into its components and checking if
