## **ѕриложение, позвол€ющее индексировать web-страницы и осуществл€ть по ним быстрый поиск.**
<!-- TOC -->
* движок разрабатываетс€ на фреймворке Spring;
* в многопоточном режиме обходит все страницы сайта начина€ с главной;
...
### **ƒл€ работы приложени€ необходимо, установить на компьютер _MySQL_ дл€ хранени€ данных проиндексированных сайтов.** 
